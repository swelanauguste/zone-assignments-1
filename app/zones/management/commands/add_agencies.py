...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        ...
        for agency in ZONE_ONE_AGENCIES:
            zone = Zone.objects.get(zone_name__icontains="zone 1")
        ...
        for agency in ZONE_TWO_AGENCIES:
            zone = Zone.objects.get(zone_name__icontains="zone 2")
            agency_name = agency.replace("\n", "")
            Agency.objects.get_or_create(
                zone=zone,
                agency_name=agency_name,
        ...
        for agency in ZONE_THREE_AGENCIES:
            zone = Zone.objects.get(zone_name__icontains="zone 3")
            agency_name = agency.replace("\n", "")
            Agency.objects.get_or_create(
                zone=zone,
                agency_name=agency_name,
        ...
        for agency in ZONE_FOUR_AGENCIES:
            zone = Zone.objects.get(zone_name__icontains="zone 4")
            agency_name = agency.replace("\n", "")
            Agency.objects.get_or_create(
                zone=zone,
                agency_name=agency_name,
        ...
        for agency in ZONE_FIVE_AGENCIES:
            zone = Zone.objects.get(zone_name__icontains="zone 5")
            agency_name = agency.replace("\n", "")
            Agency.objects.get_or_create(
                zone=zone,
                agency_name=agency_name,
